...
use App\Repositories\ParentActivityRepository;
use App\Utils\Response;

class ParentActivityController
{
    private ParentActivityRepository $repo;

    public function __construct()
    {
        $this->repo = new ParentActivityRepository();
    }
    ...
    {
        if (empty($user['role']) || $user['role'] !== 'parent') {
            Response::forbidden('Parent access required');
            return false;
        }
        return true;
    }
    ...
    // -------------------------------------------------------------------------
    // GET /parent-activity/recent?limit=10
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // GET /parent-activity/type/{type}?page=1&limit=25
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // GET /parent-activity/severity/{severity}?page=1&limit=25
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // GET /parent-activity/performer/{userId}?page=1&limit=25
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // DELETE /parent-activity/cleanup?days=90
    // -------------------------------------------------------------------------
